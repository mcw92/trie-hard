...
if __name__ == "__main__":
    ...
    print(
        f"Serial case using one CPU core: Building trie took {elapsed_build_serial} s, "
    ...
    print(
        f"Parallel case using all available CPU cores: Building and merging trie took {elapsed_build_merged} s, "
    ...
    print(
        f"Parallel case using all available CPU cores: Building local tries took {elapsed_build_parallel} s, "
